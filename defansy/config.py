...
config_dir = appdirs.user_config_dir('defansy')
data_dir = appdirs.user_data_dir('defansy')
...
config = {
	'protected_classes': ['defansy', 'target', 'service', 'commandstreamreader', 'plugin', 'portscan', 'report', 'servicescan', 'global', 'pattern'],
