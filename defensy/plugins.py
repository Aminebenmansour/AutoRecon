...
from defensy.config import config
from defensy.io import slugify, info, warn, error, fail, CommandStreamReader
from defensy.targets import Service
...
class Plugin(object):
	...
	def add_option(self, name, default=None, help=None):
		self.defensy.add_argument(self, name, metavar='VALUE', default=default, help=help)

	@final
	def add_constant_option(self, name, const, default=None, help=None):
		self.defensy.add_argument(self, name, action='store_const', const=const, default=default, help=help)

	@final
	def add_true_option(self, name, help=None):
		self.defensy.add_argument(self, name, action='store_true', help=help)

	@final
	def add_false_option(self, name, help=None):
		self.defensy.add_argument(self, name, action='store_false', help=help)

	@final
	def add_list_option(self, name, default=None, help=None):
		self.defensy.add_argument(self, name, nargs='+', metavar='VALUE', default=default, help=help)
	...
	def add_choice_option(self, name, choices, default=None, help=None):
		...
		self.defensy.add_argument(self, name, choices=choices, default=default, help=help)
	...
	def get_option(self, name, default=None):
		...
		if name in vars(self.defensy.args):
			if vars(self.defensy.args)[name] is None:
				if default:
					return default
				else:
					return None
			else:
				return vars(self.defensy.args)[name]
		else:
			if default:
				return default
			return None
