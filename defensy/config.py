...
config_dir = appdirs.user_config_dir('defensy')
data_dir = appdirs.user_data_dir('defensy')
...
config = {
	'protected_classes': ['defensy', 'target', 'service', 'commandstreamreader', 'plugin', 'portscan', 'report', 'servicescan', 'global', 'pattern'],
